...
function StatusTag({ status }) {
  ...
  return (
    <span style={{
      display: "inline-block", fontSize: 9, letterSpacing: ".32em", textTransform: "uppercase",
...
function BottomNav({ page, setPage }) {
  ...
  return (
    <nav style={{
      position: "sticky", bottom: 0, padding: "0 4px", background: "rgba(8,8,8,0.94)",
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 24 }}>
      ...
      <div style={{ padding: "28px 24px 0", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          <div style={{
            fontFamily: "'Bebas Neue',cursive", fontSize: 30, letterSpacing: ".07em",
        ...
        <div style={{
          width: 40, height: 40, borderRadius: "50%", background: "linear-gradient(135deg,#e8210a,#f56a00)",
          display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: 15,
          cursor: "pointer", boxShadow: "0 0 18px rgba(232,33,10,0.32)"
        }}>S</div>
      </div>

      {/* Wallet Balance Card */}
      <div style={{
        margin: "20px 20px 0", borderRadius: 24, padding: "28px 24px 24px",
        ...
        <div style={{
          fontFamily: "'Bebas Neue',cursive", fontSize: "clamp(44px,11vw,62px)", letterSpacing: ".02em",
        ...
        <div style={{ ...glass, borderRadius: 20, overflow: "hidden", position: "relative" }}>
          ...
          {visible.map((t, i) => (
            <div key={t.id}
              ...
              style={{
                padding: "15px 18px", display: "flex", justifyContent: "space-between", alignItems: "center",
      ...
      <div style={{ padding: "22px 20px 0" }}>
        ...
        {step === 1 && (
          <div>
            ...
            <div style={{ display: "flex", gap: 8, marginBottom: 22 }}>
              {["1000", "5000", "10000", "25000", "50000"].map(v => (
                <button key={v} onClick={() => setAmount(v)}
                  style={{
                    ...ghostBtn, flex: 1, padding: "10px 0", fontSize: 11, borderRadius: 10,
            ...
            {/* Info card */}
            <div style={{
              ...glass, borderRadius: 18, padding: "18px 20px", marginBottom: 22,
        ...
        {step === 2 && (
          <div>
            {/* Razorpay card */}
            <div style={{
              ...glassStrong, borderRadius: 22, overflow: "hidden", marginBottom: 20,
              border: "1px solid rgba(255,255,255,0.12)"
            }}>
              {/* Razorpay header */}
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
                  {[
                    ...
                    <div key={m.label} style={{
                      ...glass, borderRadius: 12, padding: "12px 8px", textAlign: "center",
        ...
        {step === 3 && (
          <div style={{ textAlign: "center", paddingTop: 40 }}>
            <div style={{
              ...
              display: "flex", alignItems: "center", justifyContent: "center",
              fontSize: 34, animation: "spin 1.2s linear infinite"
            }}>⟳</div>
        ...
        {step === 4 && (
          <div style={{ textAlign: "center", paddingTop: 32 }}>
            <div style={{
              ...
              boxShadow: "0 0 40px rgba(74,222,128,0.15)", color: "#4ade80"
            }}>✓</div>
            ...
            <div style={{
              ...glass, borderRadius: 18, padding: "20px 22px", marginBottom: 22,
              border: "1px solid rgba(74,222,128,0.2)", background: "rgba(74,222,128,0.04)"
            }}>
              <div style={{
                fontFamily: "'Bebas Neue',cursive", fontSize: 44, letterSpacing: ".02em",
      ...
      <div style={{ padding: "22px 20px 0" }}>
        ...
        {step === 1 && (
          <div>
            {/* Wallet balance pill */}
            <div style={{
              ...glass, borderRadius: 12, padding: "12px 16px", marginBottom: 20,
            ...
            <div style={{ marginBottom: 18 }}>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input type="number" style={{
                  ...inp, paddingLeft: 38, fontSize: 26, fontWeight: 700,
        ...
        {step === 2 && selected && (
          <div>
            {/* Transfer summary */}
            <div style={{
              ...glassStrong, borderRadius: 22, padding: "24px 22px", marginBottom: 16,
              border: "1px solid rgba(232,33,10,0.22)",
              background: "linear-gradient(135deg,rgba(232,33,10,0.1) 0%,rgba(14,14,14,0.9) 100%)"
            }}>
              <div style={{ textAlign: "center", marginBottom: 20 }}>
                <div style={{
                  fontFamily: "'Bebas Neue',cursive", fontSize: 42, letterSpacing: ".02em",
            ...
            <div style={{
              borderRadius: 22, padding: "22px 22px", marginBottom: 16,
              ...
              <div style={{
                ...glass, borderRadius: 16, padding: "20px 20px", marginBottom: 16,
                ...
                <div style={{
                  fontFamily: "'Bebas Neue',cursive", fontSize: 48, letterSpacing: ".02em",
              ...
              <div style={{
                ...glass, borderRadius: 14, padding: "16px 18px",
        ...
        {step === 3 && (
          <div>
            ...
            <div style={{
              ...glass, borderRadius: 18, padding: "18px 20px", marginBottom: 20,
            ...
            {!paying ? (
              <button style={{
                ...brandBtn, width: "100%", padding: 20, fontSize: 16, letterSpacing: ".12em",
              ...
              <div style={{
                ...glass, borderRadius: 18, padding: "22px 20px", textAlign: "center",
        ...
        {phase === "tokenizing" && (
          <>
            ...
            <div style={{
              ...
              <div style={{
                fontFamily: "'Bebas Neue',cursive", fontSize: 22, letterSpacing: ".1em",
        ...
        {phase === "successful" && (
          <>
            ...
            <div style={{
              ...
              <div style={{
                fontFamily: "'Bebas Neue',cursive", fontSize: 18, letterSpacing: ".1em",
      ...
      <div style={{ margin: "22px 20px 0", position: "relative" }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 28 }}>
            <div>
              <div style={{
                fontFamily: "'Bebas Neue',cursive", fontSize: 22, letterSpacing: ".18em",
                background: "linear-gradient(90deg,#fff,#f56a00)", WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent", backgroundClip: "text"
              }}>TOKIFY</div>
          ...
          <div style={{ marginBottom: 6 }}>
            ...
            <div style={{
              fontFamily: "'Bebas Neue',cursive", fontSize: "clamp(46px,13vw,66px)", letterSpacing: ".02em", lineHeight: 1,
          ...
          <div style={{
            ...
            {/* Chip icon */}
            <div style={{
              width: 44, height: 34, borderRadius: 6, border: "1px solid rgba(245,106,0,0.3)",
    ...
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 24 }}>
      ...
      {!done ? (
        <div style={{ padding: "24px 20px 0" }}>
          ...
          <div style={{ display: "flex", gap: 8, marginBottom: 18, flexWrap: "wrap" }}>
            {["1000", "5000", "10000", "25000"].map(v => (
              <button key={v} onClick={() => setAmount(v)}
                style={{
                  ...ghostBtn, padding: "8px 14px", fontSize: 11, borderRadius: 10,
          ...
          {amt > 0 && !insufficient && (
            <div style={{
              ...glass, borderRadius: 16, padding: "16px 18px", marginBottom: 20,
        ...
        <div style={{ padding: "40px 20px", textAlign: "center" }}>
          <div style={{
            width: 80, height: 80, borderRadius: "50%", background: "rgba(74,222,128,0.1)", border: "2px solid rgba(74,222,128,0.3)",
            display: "flex", alignItems: "center", justifyContent: "center", fontSize: 36, margin: "0 auto 20px", color: "#4ade80"
          }}>✓</div>
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 24 }}>
      ...
      <div style={{ padding: "28px 20px 0" }}>
        ...
        {isCompleted && !tokenized && !minting && (
          <div style={{
            ...
            <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
              <div style={{
                width: 46, height: 46, minWidth: 46, borderRadius: 13,
                background: "linear-gradient(135deg,#e8210a,#f56a00)",
                display: "flex", alignItems: "center", justifyContent: "center",
        ...
        {minting && (
          <div style={{
            ...glass, borderRadius: 20, padding: "24px 22px", textAlign: "center",
        ...
        {tokenized && (
          <div style={{
            borderRadius: 20, padding: "22px 22px", textAlign: "center",
    ...
    <div style={{ flex: 1, overflowY: "auto", paddingBottom: 24 }}>
      <div style={{ padding: "32px 24px 0", textAlign: "center" }}>
        <div style={{
          ...
          background: "linear-gradient(135deg,#e8210a,#f56a00)",
          display: "flex", alignItems: "center", justifyContent: "center",
          fontWeight: 700, fontSize: 26, boxShadow: "0 0 28px rgba(232,33,10,0.3)"
        }}>S</div>
...
export default function Dashboard({ onLogout }) {
  ...
  return (
    <div style={{
      background: "#080808", color: "#fff", fontFamily: "'Syne',sans-serif",
